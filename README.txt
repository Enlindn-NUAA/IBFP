...
3. Because of the limit of repository space, there includes no data for training. If you are interested in our research, please contact us for mobike data.
4. The preprocessing programs for 'DiDi HaiKou' are also include in /IBFPforDidi/pre-process.
...
5. For convenience, we also provide the IBFP for DiDi.
